...
echo "Stopping Jotly production services..."
"${COMPOSE_CMD[@]}" --env-file "$ENV_FILE" -f docker-compose.prod.yml -p "$COMPOSE_PROJECT_NAME" down

echo "Jotly production services stopped."
